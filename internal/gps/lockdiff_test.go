...
func TestDiffProjects_NoChange(t *testing.T) {
	p1 := NewLockedProject(mkPI("github.com/icron/dep/internal/gps"), NewVersion("v0.10.0"), []string{"gps"})
	p2 := NewLockedProject(mkPI("github.com/icron/dep/internal/gps"), NewVersion("v0.10.0"), []string{"gps"})
